        ...
        <div class="cons_body_contenedor">
            <table border="2">
                <thead>
                  ...
                  <?php
$save=conectar();
$save=$save->prepare("SELECT * FROM contacto");
$save->execute();
...
<tr>
  ...
  <td><a href="<?php echo "../paginas_con/editarcontac.php?id=" .$result->id?>"><img src="../../assets/image/iconos/iconoeditar.png" width="40" height="40"></a></td>
  <td><a href="<?php echo "../paginas_con/eliminarcontac.php?id=" .$result->id?>"><img src="../../assets/image/iconos/iconoeliminar.png" width="40" height="40"></a></td>
  </tr>
...
<?php } $save=null;?>
        ...
        <div class="cons_body_boton">
            <button><a href="./../reportes/r_contacto.php" target="_blanck">Descarga consulta de Contactos</a></button>
        </div>
    </main>
